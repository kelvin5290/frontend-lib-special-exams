...
function fetchExamProgress(_x21, _x22) {
  return _fetchExamProgress.apply(this, arguments);
}
function _fetchExamProgress() {
  _fetchExamProgress = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee16(courseId, targetUserId) {
    var url, _yield$getAuthenticat4, data;
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        case 0:
          url = new URL("".concat((0, _frontendPlatform.getConfig)().LMS_BASE_URL, "/api/course_home/progress/").concat(courseId));
          if (targetUserId) {
            url + "/".concat(targetUserId, "/"), _readOnlyError("url");
          }
          _context16.next = 4;
...
function fetchProctoringSettings(_x23, _x24) {
  return _fetchProctoringSettings.apply(this, arguments);
}
function _fetchProctoringSettings() {
  _fetchProctoringSettings = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17(courseId, examId) {
...
function fetchExamAccessToken(_x25) {
  return _fetchExamAccessToken.apply(this, arguments);
}
function _fetchExamAccessToken() {
  _fetchExamAccessToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee18(examId) {
    ...
    return _regeneratorRuntime().wrap(function _callee18$(_context18) {
      while (1) switch (_context18.prev = _context18.next) {
        case 0:
          ...
          return (0, _auth.getAuthenticatedHttpClient)().get(url.href);
        case 3:
          _yield$getAuthenticat6 = _context18.sent;
